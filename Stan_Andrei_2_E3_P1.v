...
Notation "'int' X ~> V [ nr1 ] [ nr2 ]" := (Decboolmat V nr1 nr2)(at level 50).
...
Inductive ft :=
| Decftint: Env ~ L Dec ~ Stmt ~ ft
| Decftbool: Env ~ L Dec ~ Stmt ~ ft
| Decftstring: Env ~ L Dec ~ Stmt ~ ft.
Notation "'string' A ( B1 , B2 , .. , Bn ){ C }" := (Decftstring A (cons B1 ( cons B2 .. (cons Bn nil) .. ) ) C) (at level 50).
Notation "'int' A ( B1 , B2 , .. , Bn ){ C }" := (Decftint A (cons B1 ( cons B2 .. (cons Bn nil) .. ) ) C) (at level 50).
Notation "'bool' A ( B1 , B2 , .. , Bn ){ C }" := (Decftbool A (cons B1 ( cons B2 .. (cons Bn nil) .. ) ) C) (at level 50).
